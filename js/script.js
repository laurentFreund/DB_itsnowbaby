...
$(function(){
	...
	$('.box').hover(function(){$(this)
		.find('.part1').stop().animate({bottom:'-100px'},400,'easeInQuad')
		.parent().find('.bgbox').stop().animate({height:'438px'},600,'easeInQuad')
		.parent().find('.title-2').stop().animate({bottom:'377px'},700,'easeInQuad')
		.parent().find('.text-2').stop().animate({bottom:'79px'},800,'easeInQuad')
		.parent().find('.boxbutton').stop().animate({bottom:'35px'},900,'easeInQuad')
		},
		(function(){$(this)
		.find('.boxbutton').stop().animate({bottom:'-200px'},500,'easeOutQuad')
		.parent().find('.text-2').stop().animate({bottom:'-400px'},600,'easeOutQuad')
		.parent().find('.title-2').stop().animate({bottom:'-450px'},300,'easeOutQuad')
		.parent().parent().find('.bgbox').stop().animate({height:'0px'},400,'easeOutQuad')
		.parent().parent().find('.part1').stop().animate({bottom:'25px'},300, 'easeInQuad')
		})
		)
})			
